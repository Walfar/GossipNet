...
type Messaging interface {
	...
	SendFriendRequest(address string) error

	SendMsgToFriend(friend string, myString string) error

	SetPersonalPost(Message string) error

	GetPersonalPost(dest string, msg transport.Message) error
  
	EncryptedMessage(friend string, msg transport.Message) error

	AcceptFriendRequest(address string) error

	DeclineFriendRequest(address string) error
}
