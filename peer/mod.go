...
type Peer interface {
	...
	Messaging
	DataSharing
	Username // Set a customized username via Paxos and blockchain
	Bully    // Select a coordinator to facilitate Paxos
...
type Configuration struct {
	...
	// BullyNetwork defines the network of peers to be used by the bully algorithm
	// This is to be used together with Paxos
	// The key is paxos ID, value is the network address
